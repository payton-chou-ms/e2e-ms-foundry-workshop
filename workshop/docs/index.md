...
當你把主線跑通之後，可以再從首頁先認識五個核心主軸；`多代理程式延伸` 會另外放在延伸主題中介紹：
...
如果你要再往後延伸成更多角色與工作流，請到深入解析章節查看第六個主題：**多代理程式延伸**。
...
| 路徑 | 適合誰 | 你會完成什麼 |
|------|--------|----------------|
| **管理員部署** | 你要自己把整套 Azure 與 Fabric 環境準備好 | 部署 Azure 資源、設定 Fabric，並整理出可重複使用的環境 |
...
| **3. 深入解析** | 回頭理解這個 PoC 背後的模型、代理程式、工具、接地流程與控制平面，方便你回答 Q&A 或往後延伸 | ~15 min |
