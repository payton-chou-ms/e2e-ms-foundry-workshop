...
| `資料延伸（附錄）` | 要在主線完成後，再補資料問答 | Path 1 的所有條件，加上附錄資料工作區與對應權限 |
...
如果你要在主線完成後，再補文件 + 資料整合驗證，請改看 [附錄延伸](../05-appendix/index.md)。
