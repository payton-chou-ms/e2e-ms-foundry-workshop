"""Deprecated shim for the docs-only workshop demo path."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print_deprecation_notice("admin_prepare_docs_demo.py", "admin_prepare_shared_demo.py --mode foundry-only")
